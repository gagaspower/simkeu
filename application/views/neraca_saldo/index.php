...
<script>
    ...
    $(function () {
        ...
        function searchItem() {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url();?>get-neraca-saldo",
                    data: {
                    ...
                    success: function (data) {
                        var html = '';
                        html += '<center><strong><h3>NERACA SALDO</h3><br><h4>Periode : ' + data.periode.bulan_periode + '&nbsp;' + data.periode.tahun_periode + '</h4></strong></center>';
