            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="box box-primary">
                        <form role="form" method="post" action="<?php echo base_url('karyawan/update');?>">
                        <input type="hidden" name="id" value="<?php echo $id;?>">
                             ...
                             <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputEmail1"  name="nama_karyawan"  value="<?php echo $nama_karyawan;?>" autocomplete="off">
                                </div>

                                <div class="form-group">
                                    <label for="exampleInputEmail1">Alamat Karyawan</label>
                                    <textarea class="form-control" id="exampleInputEmail1"  name="alamat_karyawan"><?php echo $alamat_karyawan;?></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Umur Karyawan</label>
                                    <input type="number" min="0" class="form-control" id="exampleInputPassword1"  name="umur_karyawan" autocomplete="off" value="<?php echo $umur_karyawan;?>">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Tlp Karyawan</label>
                                    <input type="text"  class="form-control" id="exampleInputPassword1"  name="tlp_karyawan" autocomplete="off" value="<?php echo $tlp_karyawan;?>">
                                </div>
                            </div>
